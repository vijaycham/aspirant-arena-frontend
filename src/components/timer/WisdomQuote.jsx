...
const WisdomQuote = () => {
  ...
  return (
    <div className="glass-card p-8 rounded-[2rem] border border-white/60 shadow-lg relative overflow-hidden group hover:shadow-xl transition-all duration-500">
      ...
      <p className="text-sm font-semibold leading-relaxed italic text-gray-700 group-hover:text-gray-900 transition-colors duration-300">
        “{quote}”
      </p>
    </div>
  );
