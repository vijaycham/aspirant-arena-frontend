  ...
  return (
    <div className="glass-card dark:bg-slate-900/60 dark:border-white/10 dark:shadow-black/50 p-8 rounded-[2rem] border border-white/60 shadow-lg relative overflow-hidden">
      ...
      <div className="grid grid-cols-2 gap-4">
        {/* Total Sit */}
        <div className="flex flex-col items-start gap-2 p-3 bg-primary-50/30 dark:bg-primary-900/20 rounded-2xl border border-primary-100/20 dark:border-primary-500/10 group/intel relative cursor-pointer">
