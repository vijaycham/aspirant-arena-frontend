...
const SessionArchive = ({
  ...
  return (
    <div className="mt-8 md:mt-12 bg-white dark:bg-slate-900 p-6 md:p-8 rounded-[1.5rem] md:rounded-[2.5rem] shadow-sm border border-gray-100 dark:border-white/5 overflow-hidden">
      <div className="flex justify-between items-center mb-6 md:mb-8 px-2">
        <h3 className="text-base md:text-lg font-black text-gray-800 dark:text-white">Archive of Sessions</h3>
        <div className="flex items-center gap-3">
          ...
          {filteredTests.length > 10 && (
            <div className="flex items-center gap-1 md:gap-2 mr-2 md:mr-4">
              <button
                ...
                disabled={page === 1}
                className="p-1 md:p-2 hover:bg-gray-100 dark:hover:bg-slate-800 rounded-lg disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
              >
                <svg className="w-3 h-3 md:w-4 md:h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M15 19l-7-7 7-7"></path>
                </svg>
              </button>
              <span className="text-[10px] md:text-xs font-black text-gray-400 bg-gray-50 dark:bg-slate-800 px-2 py-1 rounded-md">
          ...
          <span className="bg-primary-50 dark:bg-primary-900/10 text-primary-600 dark:text-primary-400 text-[8px] md:text-[10px] font-black px-3 py-1.5 md:px-4 md:py-2 rounded-xl md:rounded-2xl uppercase tracking-widest border border-primary-100 dark:border-primary-500/10">
      ...
      {loading ? (
        ...
        <div className="py-12 md:py-24 text-center p-6 md:p-12 bg-gray-50 dark:bg-slate-800/20 rounded-[1.5rem] md:rounded-[3rem] border-4 border-dotted border-gray-200 dark:border-white/5">
        ...
        <div className="overflow-x-auto -mx-6 md:mx-0">
          <div className="min-w-[700px] px-6 md:px-0">
            <table className="w-full text-left">
              <thead>
                <tr className="bg-gray-50/50 dark:bg-slate-800/50 text-[9px] md:text-[10px] font-black text-gray-400 uppercase tracking-widest">
                ...
                {filteredTests.slice((page - 1) * 10, page * 10).map((t) => (
                  <tr
                    ...
                    className={`group transition-all cursor-default align-middle ${
                      editingId === t._id ? "bg-indigo-50 dark:bg-indigo-900/10 hover:bg-indigo-100 dark:hover:bg-indigo-900/20" : "hover:bg-gray-50/30 dark:hover:bg-slate-800/30"
                    }`}
                  >
                    <td className="px-4 md:px-8 py-4 md:py-6 align-middle">
                      <div className="flex flex-col">
                        <span className="text-[11px] md:text-sm font-black text-gray-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors">
                          {t.subject}
                        </span>
                    ...
                    <td className="px-4 md:px-8 py-4 md:py-6 align-middle">
                      <div className="flex flex-col items-center">
                        <span className="text-[12px] md:text-base font-black text-gray-900 dark:text-white">
                          {Math.round((t.marksObtained / (t.totalMarks || 1)) * 100)}%
                        </span>
                        <div className="w-10 md:w-16 h-1 bg-gray-100 dark:bg-slate-700 rounded-full mt-1 overflow-hidden">
                          <div
                    ...
                    <td className="px-4 md:px-6 py-4 md:py-6 align-middle text-center md:text-left">
                      <span className="text-[8px] md:text-[11px] font-black text-gray-500 bg-gray-50 dark:bg-slate-800 px-2 py-1 rounded-lg uppercase tracking-tighter whitespace-nowrap border border-gray-100/50 dark:border-white/5">
                    ...
                    <td className="px-4 md:px-4 py-4 md:py-6 text-center align-middle">
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-1.5 px-2.5 md:px-3 py-1.5 bg-indigo-50/50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-600 hover:text-white dark:hover:text-white rounded-lg transition-all text-[8px] md:text-[9.5px] font-black uppercase tracking-tighter shadow-sm border border-indigo-100/50 dark:border-indigo-500/20 group/btn"
                      >
