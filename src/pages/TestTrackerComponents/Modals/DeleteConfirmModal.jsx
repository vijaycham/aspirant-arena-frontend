...
const DeleteConfirmModal = ({ confirmDeleteData, setConfirmDeleteData, handleDelete }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white p-6 md:p-8 rounded-[2rem] md:rounded-[3rem] shadow-2xl max-w-sm w-full border border-gray-100 scale-100 animate-in zoom-in-95 duration-200">
        <div className="w-12 h-12 md:w-16 md:h-16 bg-rose-50 text-rose-500 rounded-2xl md:rounded-3xl flex items-center justify-center text-2xl md:text-3xl mx-auto mb-6">
          🗑️
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 md:gap-4">
          <button
            ...
            className="py-3 md:py-4 bg-gray-50 text-gray-500 font-black rounded-xl md:rounded-2xl hover:bg-gray-100 transition-all uppercase tracking-widest text-[9px] md:text-[10px]"
          >
            Cancel
          </button>
          <button
